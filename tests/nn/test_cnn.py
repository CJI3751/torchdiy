...
def test_maxpool2d():
    ...
    # 使用手動實現的 MaxPool2d
    maxpool_custom = torchdiy.nn.MaxPool2d(kernel_size=2, stride=2)
...
def test_conv2d():
    ...
    # 使用手動實現的 Conv2d
    conv_custom = torchdiy.nn.Conv2d(in_channels=1, out_channels=1, kernel_size=3, stride=1, padding=1, bias=True)
